...
trainer = mz.trainers.Trainer(
    ...
    epochs=5,
    device=device,
    save_dir='Trained_model/knrm_model' # Chỉ định thư mục để lưu model
)
...
preprocessor.save('Trained_model/knrm_model/preprocessor') # Lưu preprocessor vào cùng thư mục
